...
<body>
    ...
    <nav id="nav" class="navbar navbar-expand-lg navbar-light ">
        ...
        <div class="collapse navbar-collapse  " id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <!-- bookings page -->
                <li class="nav-item ">
                    <a style="color: orangered !important; font-size: 20px !important;" class="nav-link"
    ...
    <div class="container">
        ...
        <p>
            Please fill in this form in order to rquest an appointment with our office. Mandatory fields are marked with
            asterisk(*).
        </p>
        <hr>
        ...
        <form action="bookings.php" method="post">
            ...
            <input class="form-control" placeholder="kaybest" type="text" name="name" id="booking" required><br>

            <!-- email -->
            <!-- email -->
            <label for="">Email*</label>
            <input class="form-control" placeholder="kaybest@gmail.com" type="email" name="email" id="booking" required><br>

            <!-- email -->
            <!-- email -->
            <label for="">Phone</label>
            <input class="form-control" placeholder="+233 248 139 469" type="number" name="phone" id="booking"><br>
            <hr>
            ...
            <input class="form-control" type="date" name="appointmentDate" id="booking"><br>

            <!-- Time interval -->
            <!-- Time interval -->
            <label for=""> Time interval</label>
            <select class="form-control" name="timeInterval" id="booking">
            ...
            <input class="form-control" type="time" name="appointmentTime" id="booking"><br>

            <!-- appointment details -->
            <!-- appointment details -->
            <label for="">Appointment details</label>
            <textarea class="form-control" name="appointmentDetails" id="appointmentDetails" cols="30" rows="10" name="appointmentDetails" ></textarea><br>
    ...
    <div data-aos="zoom-in" data-aos-duration="2000" id="location">
        <iframe id="map"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3975.2429921847674!2d-1.761895785736614!3d4.89894474127195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfe779fbbbe8ab2d%3A0x6f82f3a0c2e1d637!2sMarket%20Cir%2C%20Takoradi!5e0!3m2!1sen!2sgh!4v1659248342118!5m2!1sen!2sgh"
            ...
            <div data-aos="zoom-in" data-aos-duration="2000" class="col-sm-4 mt-4 text-center m-auto">
                <div class="text-center m-auto">
                    ...
                    <p style="font-size: 15px; color: white; text-align: center;">
                        Follow us on our social media platforms to join us in our conversation. Feel free to ask any
                        question that borders your mind too on any of our platforms.
                    </p>
                </div>
                <div class="ml-4">
...
if(isset($_POST["submit"])){
    //database connetion
$db_connetion=mysqli_connect("localhost","root","","kabest_db");
...
$query = mysqli_query($db_connetion,"INSERT INTO bookings (`NAME`,EMAIL, PHONE, APPOINTMENT_DATE,	TIME_INTERVAL,APPOINTMENT_TIME,APPOINTMENT_DETAILS) VALUES ('$name','$email','$phone','$appointmentDate','$timeInterval','$appointmentTime','$appointmentDetails')");
